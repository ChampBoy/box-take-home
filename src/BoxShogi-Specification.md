...
```
$ python box_shogi.py -f ~/tests/initialMove.in | diff -u ~/tests/initialMove.out -
```
...
We are providing some starter code and a utility function in each language (Python, Java, or Javascript). You must use the starter code provided!

You can also use the utility function provided to handle some of the tedious input and output so that you don't need to implement it yourself. The utility function can be modified to suit your needs. It is also optional; not required to be used.
...
The test runner can be downloaded from this folder: https://cloud.box.com/v/boxshogi-testrunner
The test cases can be found here: https://cloud.box.com/v/boxshogi-test-cases
